...
from models.gligen_block import (
...
class SceneGraphPositionNet(nn.Module):
    def __init__(self,  positive_len, out_dim):
        super().__init__()
        self.positive_len = positive_len
        self.out_dim = out_dim 
    ...
    def forward(self, masks, positive_embeddings):
        masks = masks.unsqueeze(-1)
...
class UNet2DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def __init__(
        ...
        if use_gated_attention:
            ...
            self.position_net = SceneGraphPositionNet(positive_len=768*3, out_dim=cross_attention_dim)
